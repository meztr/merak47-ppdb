...
import { Container, Row, Col, Card, Modal, Button, Dropdown, DropdownButton } from 'react-bootstrap';
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          <h5>{props.data.namasiswa} | {props.data.data.sekolahasal}</h5>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        ...
        <Container fluid={true}>
          ...
          <Row>
            ...
            <Col sm={6}><BoxContent>{props.data.data.pilihan1}</BoxContent></Col>
          </Row>
          <Row>
          ...
          <Row>
            ...
            <Col sm={6}>
              <BoxContent bold italic small>
                {
                  props.data.verifikasi ? 'Berhasil (Berkas Pendaftaran Online diterima)' : 'menunggu proses verifikasi...'
                }              
              </BoxContent>
            </Col>
            {/* <Col sm={3} md={3} xl={3}>
        ...
        <Container fluid={true}>
          ...
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Verifikasi</BoxTitle></Col>
            <Col>
        ...
        <Container fluid={true}>
          <Row>
            ...
            <Col sm={6}><BoxContent>{props.data.data.namasiswa}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>NISN</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.nisn}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>NIK</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.nik}</BoxContent></Col>
          </Row>            
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>No.HP</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.nohapesiswa}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Tempat/Tanggal Lahir</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.tempatlahirsiswa} 
              <span>,</span> {props.data.data.tgllahirsiswa} {props.data.data.blnlahirsiswa} {props.data.data.tahunlahirsiswa}</BoxContent>
            </Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Jenis Kelamin</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.jeniskelamin}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Agama</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.agamaSiswa}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Kewarganegaraan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.kewarganegaraan}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Alamat</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.alamatsiswa}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Tinggal Bersama</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.tinggalbersama}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3}><BoxTitle>Jumlah Saudara</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.jmlsaudara}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3}><BoxTitle>Anak Ke-</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.anakkebrp}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3}><BoxTitle>Status Keluarga</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.statusdlmkeluarga}</BoxContent></Col>
          </Row>
        </Container>
        ...
        <Container fluid={true}>
          <Row>
            ...
            <Col sm={6}><BoxContent>{props.data.data.sekolahasal}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Status Sekolah</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.statussekolah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Alamat Sekolah</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.alamatSekolah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Tahun Lulus</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.tahunlulus}</BoxContent></Col>
          </Row>
        </Container>
        ...
        <Container fluid={true}>
          <Row>
            ...
            <Col sm={6}><BoxContent>{props.data.data.namaIbu}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Pendidikan Terakhir</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.pendidikanIbu}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Pekerjaan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.pekerjaanIbu}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Agama</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.agamaIbu}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Penghasilan/bulan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.penghasilanIbu}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>No.HP Ibu</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.nohapeIbu}</BoxContent></Col>
          </Row>
        </Container>
        ...
        <Container fluid={true}>
          <Row>
            ...
            <Col sm={6}><BoxContent>{props.data.data.namaAyah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Pendidikan Terakhir</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.pendidikanAyah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Pekerjaan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.pekerjaanAyah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Agama</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.agamaAyah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Penghasilan/bulan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.penghasilanAyah}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>No.HP Ayah</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.nohapeAyah}</BoxContent></Col>
          </Row>
        </Container>
        ...
        <Container fluid={true}>
          <Row>
            ...
            <Col sm={6}><BoxContent>{props.data.data.namaWali}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Pendidikan Terakhir</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.pendidikanWali}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Pekerjaan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.pekerjaanWali}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>Penghasilan/bulan</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.penghasilanWali}</BoxContent></Col>
          </Row>
          <Row>
            <Col sm={3} md={3} xl={3}><BoxTitle>No.HP Wali</BoxTitle></Col>
            <Col sm={6}><BoxContent>{props.data.data.nohapeWali}</BoxContent></Col>
          </Row>
        </Container>
      </Modal.Body>
      <Modal.Footer>
        ...
        <Button variant="secondary" onClick={props.onHide}>Tutup</Button>
      </Modal.Footer>
    </Modal>
  );
}
