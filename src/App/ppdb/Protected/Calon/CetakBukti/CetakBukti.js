...
import { PDFDownloadLink, PDFViewer, Document, Page, Text, StyleSheet, View, Image, Font } from '@react-pdf/renderer';
...
const Formulir = (props) => (  
  <Document title={`${props.data.kodePendaftaran}-${props.data.namasiswa}`}
  ...
  >
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <SubField sub="No.Pendaftaran (Login)" value={props.data.kodePendaftaran}/>
      ...
      <View style={styles.section}>
        ...
        <SubField sub="Tempat/Tgl Lahir" value={`${props.data.data.tempatlahirsiswa}` 
                                              + ', '
        ...
        <SubField sub="Kewarganegaraan" value={props.data.data.kewarganegaraan}/>
        <SubField sub="Alamat" value={props.data.data.alamatsiswa}/>
        <SubField sub="Tinggal Bersama" value={props.data.data.tinggalbersama}/>
        <SubField sub="Jumlah Saudara" value={props.data.data.jmlsaudara}/>
        <SubField sub="Anak ke-" value={props.data.data.anakkebrp}/>
        <SubField sub="Status Keluarga" value={props.data.data.statusdlmkeluarga}/>
      </View>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section} break>
        ...
        <SubField sub="Pendidikan Terakhir" value={props.data.data.pendidikanIbu}/>
        <SubField sub="Pekerjaan" value={props.data.data.pekerjaanIbu}/>
        <SubField sub="Agama" value={props.data.data.agamaIbu}/>
        <SubField sub="Penghasilan/Bulan" value={props.data.data.penghasilanIbu}/>
      ...
      <View style={styles.section}>
        ...
        <SubField sub="Pendidikan Terakhir" value={props.data.data.pendidikanAyah}/>
        <SubField sub="Pekerjaan" value={props.data.data.pekerjaanAyah}/>
        <SubField sub="Agama" value={props.data.data.agamaAyah}/>
        <SubField sub="Penghasilan/Bulan" value={props.data.data.penghasilanAyah}/>
      ...
      <View style={styles.section}>
        ...
        <SubField sub="Pendidikan Terakhir" value={props.data.data.pendidikanWali}/>
        <SubField sub="Pekerjaan" value={props.data.data.pekerjaanWali}/>
        <SubField sub="Penghasilan/Bulan" value={props.data.data.penghasilanWali}/>
...
class Cetak extends React.Component {
  ...
  render() {
    const TglRegistrasi = (  
      moment(this.props.dataC.createAt).format("dddd, MMMM Do YYYY,HH:mm:ss")
    );
              ...
              <Col sm={4} md={6} xl={6}>
                <Card style={{ width: '18rem' }}>
                  <Card.Body>
                    ...
                    <PDFDownloadLink 
                      document={<Formulir data={this.props.dataC} WaktuRegis={TglRegistrasi} />} 
              ...
              <Col sm={4} md={6} xl={6}>
                <Card style={{ width: '18rem' }}>
                  <Card.Body>
                    ...
                    <Card.Text>
                        Download berkas kedua yang berisi: Form Daftar Ulang, Persyaratan Lampiran Dokumen dan Fakta Integritas pada tombol di bawah
                    </Card.Text>
                    <Button variant="primary" download="FormDaftarUlang.pdf" target="_blank" href={process.env.PUBLIC_URL + '../assets/FormDaftarUlang.pdf'}>Form Daftar Ulang dll</Button>
                  </Card.Body>
                </Card>
              </Col>
              <Col sm={6} md={8} xl={10}>
                <ResponsiveEmbed aspectRatio="1by1">
                  <PDFViewer className="embed-responsive-item">
                    <Formulir data={this.props.dataC} WaktuRegis={TglRegistrasi} />
                  </PDFViewer>  
                </ResponsiveEmbed> 
              </Col>
            </Row>
